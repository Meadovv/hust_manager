                                    ...
                                    <div class="grid__row grid__full-width">
                                        ...
                                        <div class="grid__full-width">
                                            <div class="form__addroom-group grid__row">
                                                ...
                                                <div class="" style={{
                                                    ...
                                                    <input id="DIACHI" name ="DIACHI" type="text" class="form__addRoom-input" />                                                    
                                                </div>
                                            </div>
                                        </div>
                                        <div class="grid__column-6">
                                            <div class="form__addroom-group grid__row">
                                                ...
                                                <div class="grid__column-5">
                                                    <input id="GiaDien" name ="GiaDien" type="text" class="form__addRoom-input"  />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid__column-6">
                                            <div class="form__addroom-group grid__row">
                                                ...
                                                <div class="grid__column-5">
                                                    <input id="GiaNuoc" name ="GiaNuoc" type="text" class="form__addRoom-input"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid__column-6">
                                            <div class="form__addroom-group grid__row">
                                                <div class="grid__column-7" style={{
                                                    ...
                                                    <label for="Gia" class="form__addRoom-label">Gửi xe (nghìn đồng/ xe) :</label>
                                                </div>
                                                <div class="grid__column-5">
                                        ...
                                        <div class="grid__column-6">
                                            <div class="form__addroom-group grid__row">
                                                <div class="grid__column-7" style={{
                                                    ...
                                                    <label for="NumBed" class="form__addRoom-label">WiFi (nghìn đồng/ phòng) :</label>
                                                </div>
                                                <div class="grid__column-5">
                                        ...
                                        <div class="grid__column-6">
                                            <div class="form__addroom-group grid__row">
                                                <div class="grid__column-7" style={{
                                                    ...
                                                    <label for="NumToi" class="form__addRoom-label">DV Chung (nghìn đồng):</label>
                                                </div>
                                                <div class="grid__column-5">
